    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Set your pricing and royalty preferences
        </p>
      </div>
      ...
      <Card>
        <CardContent className="pt-6 space-y-6">
          <div className="space-y-4">
            ...
            <RadioGroup
              value={saleType}
              onValueChange={(value: any) => onSaleTypeChange(value)}
            >
                ...
                <Label htmlFor="fixed" className="flex-1 cursor-pointer">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      List your NFT at a fixed price
                    </p>
                  </div>
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2 p-4 border border-border rounded-lg cursor-pointer hover:bg-muted/50">
                ...
                <Label htmlFor="auction" className="flex-1 cursor-pointer">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Auction your NFT to the highest bidder
                    </p>
                  </div>
                </Label>
              </div>
          ...
          {saleType !== "not-for-sale" && (
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="price">
                  {saleType === "auction" ? "Starting Price" : "Price"}{" "}
                ...
                {ethPrice?.price && price && (
                  <p className="text-sm text-muted-foreground">
                    ≈ $
                    {(
                      Number.parseFloat(price) * ethPrice.price
                    ).toLocaleString()}
                  </p>
                )}
              </div>
          ...
          <div className="space-y-4">
            ...
            <Slider
              value={[royalty]}
              onValueChange={(value) => onRoyaltyChange(value[0])}
              max={10}
              step={0.5}
            />
            <div className="flex items-start gap-2 p-3 bg-muted rounded-lg">
              ...
              <p className="text-xs text-muted-foreground">
                You'll receive {royalty}% of the sale price every time this NFT
                is resold on secondary markets.
              </p>
            </div>
          </div>
        </CardContent>
